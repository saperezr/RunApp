...
class AlarmasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_alarmas, container, false)

        val btnAlarmas = root.findViewById<Button>(R.id.buttonCrearAlarma)

        btnAlarmas.setOnClickListener{
            findNavController().navigate(R.id.action_alarmasFragment_to_crearAlarmaFragment)
        }
        val btnVolver = root.findViewById<Button>(R.id.buttonVolverAlarmas)
